namespace PartsManager.Migrations
{
    ...
    public partial class Overhaul : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        PartName = c.String(maxLength: 255),
                        PartNumber = c.String(maxLength: 255),
                        ManufacturerCode = c.String(maxLength: 5),
                        PartTypeId = c.Int(nullable: false),
                        PartLocationId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.PartLocations", t => t.PartLocationId, cascadeDelete: true)
                .ForeignKey("dbo.PartTypes", t => t.PartTypeId, cascadeDelete: true)
                .Index(t => t.PartTypeId)
                .Index(t => t.PartLocationId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Parts", "PartLocationId", "dbo.PartLocations");
            ...
            DropIndex("dbo.Parts", new[] { "PartLocationId" });
